...
function Hb() {
  ...
  return (
    <div>
      <div
        className={`  [@media(min-width:1245px)]:hidden  h-[4.7rem]  duration-100 z-[120] fixed inset-0 w-full 
      bg-[#261f1d]
       `}
      >
        <div className={`flex   relative   w-[80%] m-auto justify-between`}>
          <img
            className={`invert duration-100 mt-3  w-[11rem] h-[3.4rem]`}
            src="/marcylogo2.png"
          ></img>
