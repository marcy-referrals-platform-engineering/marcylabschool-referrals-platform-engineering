...
import { useDraggable } from "./hooks"; // Custom hook for drag behavior
import RewardMilestone from "./components/RewardMilestone";

const RewardProgress: React.FC = () => {
  // State to hold the current points and hovered milestone
  ...
  // Using custom hook for drag and scroll functionality
  const { handleMouseDown, handleMouseMove } = useDraggable(progressRef);

  // Fetching user points data when the component mounts
  useEffect(() => {
