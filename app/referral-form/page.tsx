...
export default function page() {
  ...
  return (
    <div className="w-screen  bg-[#F1F3F4] h-full ">
      <img
        src="/fellows1.png"
        className=" object-cover w-[700px] h-[200px] m-auto"
      />
      <form
        onSubmit={handleSubmit}
        className=" p-8 bg-white max-w-[700px] mx-auto rounded-lg shadow-md"
      >
        ...
        <p className="text-gray-700 mb-6">
          ...
          form to submit a referral. Remember, LinkedIn profiles and resumes are
          highly encouraged.
        </p>
