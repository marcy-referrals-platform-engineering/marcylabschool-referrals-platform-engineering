...
interface UserStatsProps {
  ...
  statsLoaded: boolean;
  setStatsLoaded: (value: boolean) => void;
  percentIncrease: { referrals: number; points: number };
}
...
const UserStats: React.FC<UserStatsProps> = ({
  ...
  <>
    <CardDataStats
      ...
      title="Total Points"
      total={selectedUserStats?.totalPoints || userStats.totalPoints}
    ...
    <CardDataStats
      ...
      total={selectedUserStats?.totalReferrals || userStats.totalReferrals}
